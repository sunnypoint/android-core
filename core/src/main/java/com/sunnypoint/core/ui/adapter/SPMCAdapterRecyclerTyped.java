package com.sunnypoint.core.ui.adapter;
/**
...
public abstract class SPMCAdapterRecyclerTyped<T, VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> {

    private final String TAG;
    private List<T> dataSet = new ArrayList<T>();

    public SPMCAdapterRecyclerTyped() {
