...
public class SPMCFragmentNavigator {
    ...
    private SPMCFragmentNavigator(final FragmentActivity activity, int fragmentContainerId) {
        this.fragmentContainerId = fragmentContainerId;
        this.fragmentManager = activity.getSupportFragmentManager();
    }

    public static SPMCFragmentNavigator create(FragmentActivity activity, int fragmentContainerId) {
        return new SPMCFragmentNavigator(activity, fragmentContainerId);
    }
